...
class MySubmissionsNotifier extends StateNotifier<MySubmissionsState> {
  ...
  // FIX: Use async MultipartFile.fromFile instead of sync fromFileSync
  // This prevents crashes on Android/iOS where sync file access may fail
  Future<bool> submitTask({
    ...
    try {
      ...
      for (final f in files) {
        final mf = await dio_lib.MultipartFile.fromFile(
          f['path'] as String,
